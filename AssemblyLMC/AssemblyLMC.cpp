...
int main()
{
    ...
    std::array<std::string, 3> res3 = experis::ProcessAssemblyLineData(" three     dat 1 ");
    std::array<std::string, 3> res4 = experis::ProcessAssemblyLineData(" three     dat 1 ");
    std::array<std::string, 3> res5 = experis::ProcessAssemblyLineData("  dat 1 ");
    std::array<std::string, 3> res6 = experis::ProcessAssemblyLineData("one  dat ");
